...
<html lang="en">
  <head>
    ...
    <link
    href="{{URL::asset('bootstrap.min.css') }}"
    rel="stylesheet"
  ...
  />
    <script
    defer
    src="{{URL::asset('bootstrap.bundle.min.js') }}"
          ...
          <div class="container-fluid ror">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4">
              <div class="col d-flex justify-content-center">
                <figure class="figure">
                  <img
                    src="https://scontent.fcrk2-1.fna.fbcdn.net/v/t39.30808-6/336161831_2037180583146892_8611556564840816492_n.jpg?_nc_cat=111&cb=99be929b-3346023f&ccb=1-7&_nc_sid=09cbfe&_nc_eui2=AeGD25-nhi8q_QgkrvAvxlTrfoO7ipaoXSB-g7uKlqhdIDcEs9IBVFK3aVHRlpTKLkan7umR-JcpYYuTJqPeBri-&_nc_ohc=rmgUSkeCY4MAX_1cXzj&_nc_ht=scontent.fcrk2-1.fna&oh=00_AfC7j_dMAig4j2gp9JjAJRjPBRm-bgcNyskrG7ziONxG2w&oe=64A81ABE"
                    alt=""
              ...
              <div class="col d-flex justify-content-center">
                <figure>
                  <img
                    src="https://scontent.fcrk2-1.fna.fbcdn.net/v/t1.15752-9/341722262_244732088051322_6953653368100841979_n.jpg?_nc_cat=109&cb=99be929b-3346023f&ccb=1-7&_nc_sid=ae9488&_nc_eui2=AeFMrw-nb3D2DsN9lVDJPQBdbFGS8JQxqz9sUZLwlDGrP8-cNDTSUn8_llzgqWzl3ZCf0cFcmKO63y3FfegRf6lL&_nc_ohc=hzakoQSWRbwAX-1gxUW&_nc_ht=scontent.fcrk2-1.fna&oh=03_AdQ9pComxQWFA2zFefs7Wy-ccVeKanaTD5gv8zCee3TQtQ&oe=64CAD4BA"
                    alt=""
                    class="img-thumbnail figure-img"
                  />
                  <figcaption class="figure-caption text-center fs-1">
              ...
              <div class="col d-flex justify-content-center">
                <figure>
                  <img
                    src="https://scontent.fcrk2-2.fna.fbcdn.net/v/t1.6435-9/160530045_4033251773427827_6662132964161637919_n.jpg?_nc_cat=107&cb=99be929b-3346023f&ccb=1-7&_nc_sid=174925&_nc_eui2=AeEX0v-SuieSWq5280mogNvU62pJToFU1azraklOgVTVrAYme7oemIQodG5d7dIR52Alr0ljd4qRzgiweE-UaCHo&_nc_ohc=MkercNOW2S8AX844-92&_nc_ht=scontent.fcrk2-2.fna&oh=00_AfDxrNe8H0ePT5yIHmPN02ALC-z-BHMoGcH9Gwk4HS3s8g&oe=64CAE9CE"
                    alt=""
              ...
              <div class="col d-flex justify-content-center">
                <figure>
                  <img
                    src="https://scontent.fcrk2-2.fna.fbcdn.net/v/t1.15752-9/343120732_598672505658802_5897631659168997587_n.jpg?_nc_cat=100&cb=99be929b-3346023f&ccb=1-7&_nc_sid=ae9488&_nc_eui2=AeETOGuSfar_lk1tQ1iCnQsCjQC7ygpY8WiNALvKCljxaFsJ89hhdIHk6dlJygyq87trWo0OWbmF4DFXXyPKn31D&_nc_ohc=Mrua95u_a_IAX8paep9&_nc_oc=AQl_1bdBudgxMy50rjDwuOzxWZEXK4MsduQwOIXy6MKXH3dT6w_xFwsHzGIusxjGyUKyDp9DEkT5cxY3egKYdOjM&_nc_ht=scontent.fcrk2-2.fna&oh=03_AdRYXKgiZ28fqETJv4KtmW7CIloc5RmAq_FngR-lNagYPQ&oe=64CAC8ED"
                    alt=""
                    class="img-thumbnail figure-img"
                  />
                  <figcaption class="figure-caption text-center fs-1">
